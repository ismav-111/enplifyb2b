...
const SEED_LOGS: LogEntry[] = [
  {
    _id: "69b91530000000000000001",
    event_type: "login_success",
    actor: ACTOR_ANAND,
    tenant: TENANT,
    occurred_at: ts(130_000),
    details: { method: "email_password", mfa_verified: true, device: "MacBook Pro", browser: "Chrome 124" },
    level: "info",
  },
  {
    _id: "69b91530000000000000002",
    event_type: "session_created",
    actor: ACTOR_ANAND,
    tenant: TENANT,
    occurred_at: ts(129_000),
    details: { session_id: "sess_aB3kLm9p", expires_in: "8h", scope: "full" },
    level: "success",
  },
  {
    _id: "69b91530000000000000003",
    event_type: "member_role_updated",
    workspace_id: "67ffdbbf-ae83-4648-8138-568a9ea1c50e",
    workspace_name: "test",
    actor: ACTOR_ANAND,
    tenant: TENANT,
    occurred_at: ts(95_000),
    details: { member_id: "f5e8f52a-d5e1-4d00-b094-71e281802469", new_role: "member", previous_role: "owner" },
    level: "info",
  },
  {
    _id: "69b91530000000000000004",
    event_type: "workspace_created",
    workspace_id: "ab12cdef-1234-5678-abcd-ef1234567890",
    workspace_name: "Analytics Projects",
    actor: ACTOR_ANAND,
    tenant: TENANT,
    occurred_at: ts(88_000),
    details: { workspace_type: "personal", description: "Personal analytics and data exploration" },
    level: "success",
  },
  {
    _id: "69b91530000000000000005",
    event_type: "api_key_created",
    actor: ACTOR_ANAND,
    tenant: TENANT,
    occurred_at: ts(72_000),
    details: { key_id: "key_mN7pQr", name: "Production Integration", expires_in: "90 days" },
    level: "success",
  },
  {
    _id: "69b91530000000000000006",
  ...
  {
    _id: "69b91530000000000000007",
    event_type: "guardrail_triggered",
    workspace_id: "67ffdbbf-ae83-4648-8138-568a9ea1c50e",
    workspace_name: "test",
    actor: ACTOR_SARAH,
    tenant: TENANT,
    occurred_at: ts(48_000),
    details: { rule_id: "block_ssn", rule_name: "Block Social Security Numbers", action: "BLOCK", pattern_matched: "\\d{3}-\\d{2}-\\d{4}" },
    level: "warning",
  },
  {
    _id: "69b91530000000000000008",
    event_type: "member_added",
    workspace_id: "ab12cdef-1234-5678-abcd-ef1234567890",
    workspace_name: "Analytics Projects",
    actor: ACTOR_ANAND,
    tenant: TENANT,
    occurred_at: ts(35_000),
    details: { member_id: "c7d1e2f3-a4b5-6789-cdef-012345678901", member_name: "james.wilson", role: "member" },
    level: "success",
  },
  {
    _id: "69b91530000000000000009",
    event_type: "api_key_rotated",
    actor: ACTOR_ANAND,
    tenant: TENANT,
    occurred_at: ts(20_000),
    details: { key_id: "key_mN7pQr", previous_key_age: "32 days", invalidated_at: new Date(Date.now() - 20_000).toISOString() },
    level: "success",
  },
  {
    _id: "69b91530000000000000010",
    event_type: "settings_updated",
    actor: ACTOR_ANAND,
    tenant: TENANT,
    occurred_at: ts(8_000),
...
const STREAM_TEMPLATES: Omit<LogEntry, "_id" | "occurred_at" | "isNew">[] = [
  { event_type: "query_executed", workspace_id: "67ffdbbf-ae83-4648-8138-568a9ea1c50e", workspace_name: "test", actor: ACTOR_ANAND, tenant: TENANT, details: { query_id: "qry_live_1", tokens: 210, connector: "Snowflake", rows_returned: 1840, duration_ms: 920 }, level: "info" },
  { event_type: "file_uploaded", workspace_id: "ab12cdef-1234-5678-abcd-ef1234567890", workspace_name: "Analytics Projects", actor: ACTOR_SARAH, tenant: TENANT, details: { file_name: "Q4_Data.xlsx", size_bytes: 1_240_000, file_type: "excel" }, level: "success" },
  { event_type: "sync_completed", workspace_id: "67ffdbbf-ae83-4648-8138-568a9ea1c50e", workspace_name: "test", actor: ACTOR_ANAND, tenant: TENANT, details: { source: "Google Drive", files_synced: 14, duration_ms: 8200 }, level: "success" },
  { event_type: "login_failed", actor: { ...ACTOR_SARAH, user_name: "unknown.user" }, tenant: TENANT, details: { reason: "invalid_credentials", attempts: 2, ip_address: "45.33.32.156" }, level: "error" },
  { event_type: "member_removed", workspace_id: "67ffdbbf-ae83-4648-8138-568a9ea1c50e", workspace_name: "test", actor: ACTOR_ANAND, tenant: TENANT, details: { member_id: "aabb1122-1234-5678-abcd-000000000001", member_name: "bob.jones", role: "member" }, level: "warning" },
  { event_type: "guardrail_triggered", workspace_id: "ab12cdef-1234-5678-abcd-ef1234567890", workspace_name: "Analytics Projects", actor: ACTOR_SARAH, tenant: TENANT, details: { rule_id: "redact_api_keys", rule_name: "Redact API Keys", action: "REDACT" }, level: "warning" },
  { event_type: "session_expired", actor: ACTOR_ANAND, tenant: TENANT, details: { session_id: "sess_old_X9", reason: "idle_timeout", idle_duration: "30m" }, level: "warning" },
];

let streamCounter = 200;
const makeStreamEntry = (): LogEntry => {
  const t = STREAM_TEMPLATES[Math.floor(Math.random() * STREAM_TEMPLATES.length)];
  streamCounter++;
  return { ...t, _id: `stream_${streamCounter}`, occurred_at: new Date().toISOString(), isNew: true };
};
...
export const UserLogsSection = () => {
  ...
  const filtered = useMemo(() => logs.filter((log) => {
    ...
    if (search) {
      ...
      return (
        ...
        log.workspace_name?.toLowerCase().includes(q) ||
  ...
  const exportJSON = () => {
    ...
    a.download = `user-activity-${format(new Date(), "yyyy-MM-dd")}.json`;
    a.click();
  };
    ...
    <section>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          <h2 className="text-[11px] font-semibold text-muted-foreground uppercase tracking-wider">Activity Logs</h2>
          {isLive && (
      ...
      <div className="border border-border/50 rounded-xl bg-card shadow-sm overflow-hidden">
        ...
        <div className="px-4 py-3 border-b border-border/40 flex flex-wrap items-center gap-2">
          <div className="relative flex-1 min-w-[200px]">
            ...
            <Input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search event type, actor, workspace…" className="pl-8 h-7 text-xs" />
          </div>
        ...
        {/* Column header */}
        <div className="grid grid-cols-[24px_1fr_140px_100px_80px] gap-3 px-4 py-2 border-b border-border/40 bg-muted/20">
          <div />
            ...
            filtered.map((log) => {
              ...
              return (
                <button key={log._id} onClick={() => { setSelectedLog(log); setDrawerOpen(true); }}
                  className={cn("w-full text-left grid grid-cols-[24px_1fr_140px_100px_80px] gap-3 items-center px-4 py-3 hover:bg-accent/40 transition-colors group", log.isNew && "bg-success/5", row)}>
                  ...
                  <span className="text-xs text-muted-foreground truncate">{log.workspace_name ?? "—"}</span>
